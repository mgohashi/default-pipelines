...
CONFIGMAP_URL_DEV='https://gogs-cicd-tools.cloud.sfb/banestes/eap-app-rest/raw/master/configuration/configmap/eap-app-rest.yml  '
CONFIGMAP_URL_HML=$CONFIGMAP_URL_DEV
CONFIGMAP_URL_PRD=$CONFIGMAP_URL_DEV
SECRET_URL_DEV='https://gogs-cicd-tools.cloud.sfb/banestes/eap-app-rest/raw/master/configuration/secret/eap-app-rest.yml'
SECRET_URL_HML=$SECRET_URL_DEV
SECRET_URL_PRD=$SECRET_URL_DEV
REPLICAS_HML=2
REPLICAS_PRD=2
